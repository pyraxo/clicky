...
final class AssemblyAIStreamingTranscriptionProvider: BuddyTranscriptionProvider {
    private let apiKey = AppBundleConfiguration.stringValue(forKey: "AssemblyAIAPIKey")
    ...
    var unavailableExplanation: String? {
        ...
        return "AssemblyAI is not configured. Add AssemblyAIAPIKey to Info.plist."
    }
    ...
    func startStreamingSession(
        ...
        guard let apiKey else {
            throw AssemblyAIStreamingTranscriptionProviderError(
                message: unavailableExplanation ?? "AssemblyAI is not configured."
            )
        }
